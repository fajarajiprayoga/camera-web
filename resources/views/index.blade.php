        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <i class="align-middle" data-feather="camera"><</i>Go And Back
                </a>
                ...
                <div class="" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#carouselExampleSlidesOnly">Beranda</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container p-4">
            <div class="row mt-4">
                <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
                    <h5 style="letter-spacing: 2px; color: #818963;" class="text-uppercase mb-4">Tentang Kami</h5>
                ...
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                    ...
                    <form action="{{ url('/') }}" method="post">
                        ...
                        <div class="form-outline form-white mb-4">
                            <input type="email" name="subscriber" id="formControlLg"
                                class="form-control form-control-lg mb-2" placeholder="Masukkan email disini" />
                        </div>
                    ...
                    <ul class="fa-ul">
                        <li class="mb-3 mt-4">
                            <span data-feather="compass" class="fa-li"><i class="fas fa-home"></i></span><span
                                class="ms-2">Jl. Tentara Pelajar 46, Muntilan, Magelang</span>
                        </li>
                        <li class="mb-3">
                            <span data-feather="mail" class="fa-li"><i class="fas fa-envelope"></i></span><span
                                class="ms-2">toko@gmail.com</span>
                        </li>
                        <li class="mb-3">
                            <span data-feather="phone" class="fa-li"><i class="fas fa-phone"></i></span><span
                                class="ms-2">
                                081314490356</span>
                        </li>
                    </ul>
                ...
                <!--Grid column-->
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                    <h5 style="letter-spacing: 2px; color: #818963;" class="text-uppercase mb-4">Jam Buka</h5>
